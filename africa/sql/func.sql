...
CREATE VIEW stoves_number_in_region AS
SELECT district, COUNT(locations.id_district)
FROM locations JOIN districts ON locations.id_district = districts.id_district
GROUP BY locations.id_district, district
